...
namespace Deviot.Hermes.Modbus.Driver
{
    public class DeviceDriverService : IDeviceDriverService
    {
        ...
        private Common.Entities.ModbusDevice _modbusDevice;
        ...
        public void UpdateDevice(Common.Entities.ModbusDevice modbusDevice)
        {
            _status = false;
            foreach (var data in _data)
            {
        ...
        public void Start(Common.Entities.ModbusDevice modbusDevice)
        {
            if(!_status)
            {
                _data.Clear();
